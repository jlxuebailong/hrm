...
Ext.Desktop = function(app) {
    ...
    this.sysheader = new Ext.ux.SysHeader(app);
    var sysheader = this.sysheader;
    
    this.startmenubar = new Ext.ux.StartMenuBar(app);
    var startmenubar = this.startmenubar;

    var desktopEl = Ext.get('x-desktop');
    var taskbarEl = Ext.get('ux-taskbar');
    var shortcuts = Ext.get('x-shortcuts');
    var startmenubarEl = Ext.get('ux-startmenubar');
    var sysheaderEl = Ext.get('ux-sysheader');
    ...
    function layout() {
        desktopEl.setHeight(Ext.lib.Dom.getViewHeight() - taskbarEl.getHeight() - startmenubarEl.getHeight() - sysheaderEl.getHeight());
    }
    ...
    this.getWinHeight = function() {
        var height = (Ext.lib.Dom.getViewHeight() - taskbarEl.getHeight() - startmenubarEl.getHeight() - sysheaderEl.getHeight());
    ...
    this.getWinY = function(height) {
        return (Ext.lib.Dom.getViewHeight() - taskbarEl.getHeight() - startmenubarEl.getHeight() - sysheaderEl.getHeight() - height) / 2;
    };
